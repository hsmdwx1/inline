bot = dofile('/home/omega1/inline/data/utils.lua')
json = dofile('/home/omega1/inline/data/JSON.lua')
...
BASE = '/home/omega1/inline/bot/'
SUDO = 317576202 --sudo id
sudo_users = {317576202,123456789,Userid}
